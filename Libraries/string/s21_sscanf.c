...
// int main(void) {
//     const char* str = "30817264 22.22 V 012 12345.6789
//     123456789012345678901234567890.1234567890, 100"; int check_d = 0; float
//     check_f = 0.0; char check_c = '0'; int check_i = 0; float check_e = 0.0;
//     float check_g = 0.0;
//     int check_o = 0;
...
////    const char* str3 = "42";
//
//    sscanf(str, "%d %f %c %i %E %G %o", &check_d, &check_f, &check_c,
//    &check_i, &check_e, &check_g, &check_o); printf("%d\n", check_d);
//    printf("%f\n", check_f);
//    printf("%c\n", check_c);
//    printf("%d\n", check_i);
//    printf("%E\n", check_e);
