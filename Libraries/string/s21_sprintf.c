...
// static void format_double_exponential(char* str, double value, int precision,
// int* written_chars) {
//
// }
      ...
      if (*format == '.') {
        ...
        switch (*format) {
          case 'f': {
            ...
            written_chars +=
                double_to_str(str + written_chars, value, precision);
            break;
          }
            /*                   case 'e': {
                                   double value = va_arg(args, double);
                                   format_double_exponential(str +
               written_chars, value, precision, &written_chars); break;
                               }*/
          default:
            str[written_chars++] = '%';
            str[written_chars++] = '.';
        ...
        switch (*format) {
          ...
          //     double value = va_arg(args, double);
          //     int precision = 6;
          //     format_double_exponential(str + written_chars, value,
          //     precision, &written_chars); break;
          // }
          // case 'g': {
          //     double value = va_arg(args, double);
