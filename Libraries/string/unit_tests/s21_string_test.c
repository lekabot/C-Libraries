...
//
//
//void s21_strcspn_test(void) {
//    const char* __s1 = "World!";
//    const char* __s2 = "Hello!";
//    s21_size_t __r1 = s21_strcspn(__s1, __s2);
//    s21_size_t __r2 = strcspn(__s1, __s2);
//    if (__r1 == __r2) {
...
//
//
//void s21_memchr_test(void) {
//    const char* str = "Hello, World!";
//    char search = 'W';
//    s21_size_t len = s21_strlen(str);
//    intptr_t __r1 = (intptr_t)s21_memchr(str, search, len);
//    intptr_t __r2 = (intptr_t)memchr(str, search, len);
//    if (__r1 == __r2) {
